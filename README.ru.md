# ⚠️ ПРОЕКТ АРХИВИРОВАН И НЕ ПОДЛЕЖИТ ИСПОЛЬЗОВАНИЮ ПО ЭТИЧЕСКИМ СООБРАЖЕНИЯМ
...
**ДИСКЛЕЙМЕР:** Этот проект был написан где то в 2025 году как технический эксперимент на ложной предпосылке, что гражданский софт может существовать в отрыве от государственного контекста.

Армия РФ прямо сейчас совершает **геноцид** и военные преступления в Украине, а такие сервисы, как GigaChat - часть экосистемы, налоги с которой идут режиму. 

**НЕ ИСПОЛЬЗУЙТЕ ЭТУ SDK.** Не используйте российские LLM и не давайте свои данные и ресурсы российской системе. Любое использование подобного софта — молчаливое согласие с происходящим. Проект не удаляется только потому, что служит демонстрацией моих навыков. Программист, который работает на Сбер, Тинькофф и, не дай бог, пишет софт для репрессий своих граждан — это соучастник, а не «инженер вне политики».
